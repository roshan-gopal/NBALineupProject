...
import gym
from final_embeddings import LineupEmbeddings
...
class LineupEnv(gym.Env):
    def __init__(self, team_name=None):
        ...
        # Initialize lineup_embeddings
        self.lineup_embeddings = LineupEmbeddings(cache_dir="cache")
        # Try to load existing embeddings first
        if not self.lineup_embeddings.load_final_embeddings():
            # If loading fails, create new embeddings
            self.lineup_embeddings.create_embeddings()
            self.lineup_embeddings.save_final_embeddings()
